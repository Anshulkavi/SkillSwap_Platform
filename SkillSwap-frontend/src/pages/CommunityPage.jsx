...
//                       pushSkillMatches: "Push notifications for skill matches",
...
//                         Private - Only people I connect with
//                       </option>
//                     </select>
//                   </div>
...
//                       {
//                         key: "showEmail",
//                         label: "Make my email address visible",
//                       },
//                     ].map(({ key, label }) => (
//                       <label
//                         key={key}
...
//                         <button
//                           onClick={() =>
//                             handlePrivacyChange(key, !privacy[key])
//                           }
//                           className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
//                             privacy[key] ? "bg-purple-600" : "bg-gray-200"
//                           }`}
//                         >
//                           <span
//                             className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
...
//                 </h3>
//                 <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-4">
//                   <button className="w-full bg-purple-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-purple-700 transition-colors text-left">
//                     Change Password
//                   </button>
...
//                   </button>
//                   <button className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 transition-colors text-left flex items-center justify-between">
...
//                   </div>
//                   <div className="text-sm text-gray-600">
//                     <p>• Upload up to 10 videos per month</p>
//                     <p>• Basic analytics</p>
...
//                     Deactivate Account
//                   </button>
//                   <button className="w-full bg-red-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-red-700 transition-colors flex items-center justify-center space-x-2">
//                     <AlertTriangle className="h-4 w-4" />
//                     <span>Delete Account Permanently</span>
//                   </button>
//                   <p className="text-sm text-red-700">
//                     ⚠️ Account deletion is permanent and cannot be undone. All
//                     your videos, progress, and data will be lost.
//                   </p>
//                 </div>
//               </div>
...
//                   Cancel Changes
//                 </button>
//                 <button className="px-6 py-2 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700 transition-colors flex items-center space-x-2">
//                   <Save className="h-4 w-4" />
...
import { useAuth } from "../context/AuthContext"; // New way (using hook)
