...
class User(UserBase, table=True):
    ...
    sent_requests: List["SwapRequest"] = Relationship(back_populates="requester", sa_relationship_kwargs={"foreign_keys": "SwapRequest.requester_id"})
    received_requests: List["SwapRequest"] = Relationship(back_populates="listing_owner", sa_relationship_kwargs={"foreign_keys": "SwapRequest.listing_owner_id"})
    ...
    given_reviews: List["Review"] = Relationship(back_populates="reviewer", sa_relationship_kwargs={"foreign_keys": "Review.reviewer_id"})
    received_reviews: List["Review"] = Relationship(back_populates="reviewee", sa_relationship_kwargs={"foreign_keys": "Review.reviewee_id"})
...
class SwapRequest(SwapRequestBase, table=True):
    ...
    requester: User = Relationship(back_populates="sent_requests", sa_relationship_kwargs={"foreign_keys": "SwapRequest.requester_id"})
    listing_owner: User = Relationship(back_populates="received_requests", sa_relationship_kwargs={"foreign_keys": "SwapRequest.listing_owner_id"})
...
class Review(ReviewBase, table=True):
    ...
    # Relationships
    reviewer: User = Relationship(back_populates="given_reviews", sa_relationship_kwargs={"foreign_keys": "Review.reviewer_id"})
    reviewee: User = Relationship(back_populates="received_reviews", sa_relationship_kwargs={"foreign_keys": "Review.reviewee_id"})
