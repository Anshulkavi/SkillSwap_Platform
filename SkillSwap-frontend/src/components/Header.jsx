...
// import {
//     Home, User, Video, MessageCircle, Search, Bell,
//     BookOpen, Users, Menu, X, LogOut, Settings
// } from 'lucide-react';
// import Notification, { notificationsData } from './Notification';
...
//                                 className="hidden md:block relative p-2 text-slate-300 hover:text-purple-400 transition-colors rounded-lg hover:bg-slate-800"
//                             >
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            <div className="relative w-full">
              ...
              <input
                type="text"
                placeholder="Search skills, videos, or users..."
                className="w-full pl-10 pr-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-slate-200 placeholder-slate-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
              />
            </div>
          </div>
          ...
          >
            <div className="p-6 flex flex-col space-y-2">
              ...
              <div className="border-t border-slate-700 pt-4 mt-2">
                <Link
                  to="/profile"
                  className="flex items-center space-x-3 px-4 py-3 hover:bg-slate-800 rounded-lg"
                >
                  <User className="h-6 w-6 text-slate-400" />
